//
//  CauseFilterViewController.swift
//  Discovol
//
...
class CauseFilterViewController: UITableViewController {
        
        var delegate: CauseFilterViewDelegate?
        
        var model: VolunteerMatchCategories?
        ...
        override func viewDidLoad() {
            ...
            self.model = VolunteerMatchCategories(instance: VolunteerMatchCategories.instance)
        }
        ...
        override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
            ...
            default:
                ...
                switchView.addTarget(self, action: #selector(CauseFilterViewController.handleSwitchValueChanged(_:)), forControlEvents: UIControlEvents.ValueChanged)
        ...
        @IBAction func handleSearchButton(sender: AnyObject) {
            ...
            VolunteerMatchCategories.instance.copyStateFrom(self.model!)
    ...
    protocol CauseFilterViewDelegate {
        func onFiltersDone(controller: CauseFilterViewController)
}